        ...
        <div className="grid">
            <div className="col-12 md:col-6 xl:col-3">
                <div className="card h-full">
                    <span className="font-semibold text-lg">All Specialist</span>
            ...
            <div className="col-12 md:col-6 xl:col-3">
                <div className="card h-full">
                    <span className="font-semibold text-lg">New Specialist this week</span>
                    <div className="flex justify-content-between align-items-start mt-3">
                        <div className="w-6">
            ...
            <div className="col-12 md:col-6 xl:col-3">
                <div className="card h-full">
                    <span className="font-semibold text-lg">Revenue from Specialist</span>
                    <div className="flex justify-content-between align-items-start mt-3">
                        <div className="w-6">
