...
import type { ChartDataState, ChartOptionsState, Demo } from '../../../types/types';
...
export default function ECommerce() {
    ...
    useEffect(() => {
        ...
        const pieData: ChartData = {
            labels: ['Oncology', 'Gynecology', 'Neurosurgery'],
            datasets: [
                {
                    data: [300, 50, 100],
        ...
        <div className="grid">
            <div className="col-12 md:col-6 xl:col-3">
                <div className="card h-full">
                    <span className="font-semibold text-lg">Total number of Patients</span>
                    <div className="flex justify-content-between align-items-start mt-3">
                        <div className="w-6">
                            <span className="text-4xl font-bold text-900">1200</span>
            ...
            <div className="col-12 md:col-6 xl:col-3">
                <div className="card h-full">
                    <span className="font-semibold text-lg">New Patients this week</span>
                    <div className="flex justify-content-between align-items-start mt-3">
                        <div className="w-6">
                            <span className="text-4xl font-bold text-900">15</span>
                            <div className="text-green-500">
            ...
            <div className="col-12 md:col-6 xl:col-3">
                <div className="card h-full">
                    <span className="font-semibold text-lg">Revenue from Patients</span>
                    <div className="flex justify-content-between align-items-start mt-3">
                        <div className="w-6">
                            <span className="text-4xl font-bold text-900">$3600</span>
            ...
            <div className="col-12 xl:col-3">
                <div className="card h-auto">
                    <div className="text-900 text-xl font-semibold mb-6">Specialist by Category</div>
